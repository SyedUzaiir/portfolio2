...
const codingProfiles = [
  {
    ...
    link: "https://leetcode.com/u/syeduzaiir/", // Placeholder link
...
export const Activity = () => {
  ...
  return (
    <section id="activity" className="py-24 relative">
      ...
      >
        <h2 className="text-4xl md:text-5xl font-bold mb-4">Coding Activity</h2>
          ...
          {codingProfiles.map((profile, index) => (
            ...
            >
              <div className="flex justify-between items-center">
                <div>
                  <h4 className={`text-xl font-bold mb-1 ${profile.color}`}>{profile.platform}</h4>
                  <p className="text-[var(--text-secondary)]">{profile.stats}</p>
                </div>
